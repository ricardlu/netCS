...
if __name__ == '__main__':   
    ...
    sensitivity_table  = pd.read_csv('Data/ECS_and_TCR.txt', sep=" ", index_col =["name"])
    ...
    rep = 'CMIP6_metrics/'
    intra_mean_D_ACE =  np.load (rep + 'intra_model_mean_9regions_D_ACE_ref_HadISST_1975-2014.npy')
    intra_mean_D_ACE_2 = np.load (rep + 'intra_model_mean_9regions_D_ACE_ref_COBEv2_1975-2014.npy')
    ...
    # Load WWD 
    # For each run 
    mat_WWD_HadISST = np.load (rep + 'WWD_model_ref_HadISST_1975-2014.npy', allow_pickle =True)
    mat_WWD_COBEv2 = np.load (rep + 'WWD_model_ref_COBEv2_1975-2014.npy', allow_pickle =True)
    mat_WWD_mix = np.load (rep + 'WWD_model_ref_MIX_1975-2014.npy', allow_pickle =True)
    ...
    list_names_w1 = [  'unweighted', 'netCS']
    ...
    list_names_w2 = [  'unweighted', 'netCS']
